  ...
  <div class="flex flex-col items-center justify-center min-h-screen p-2xl max-w-xl mx-auto text-center">
    ...
    <template v-if="store.configCategory === 'in_place'">
      ...
      <button
        ...
        class="mt-lg px-lg py-sm rounded-[var(--radius-form-lg)] bg-[var(--color-brand-solid)] text-white text-secondary cursor-pointer hover:shadow-[var(--shadow-button-hover)] transition-all duration-[var(--motion-base)]"
    ...
    <template v-else-if="store.configCategory === 'config_missing'">
      ...
      <code class="text-secondary font-mono bg-[var(--color-danger)]/10 px-sm py-xs rounded-[var(--radius-sm)] mb-md">{{ store.rootPath }}</code>
      ...
      <div class="flex gap-md">
        <button
          ...
          class="px-lg py-sm rounded-[var(--radius-form-lg)] bg-[var(--color-brand-solid)] text-white text-secondary cursor-pointer hover:shadow-[var(--shadow-button-hover)] transition-all duration-[var(--motion-base)]"
          @click="recreate"
        >
        ...
        <button
          ...
          class="px-lg py-sm rounded-[var(--radius-form-lg)] border border-[var(--color-border-form)] text-secondary text-[var(--color-text-primary)] cursor-pointer"
          @click="pick"
        >
